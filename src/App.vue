    ...
    <div class="flex items-center">
      <div class="w-11/12 space-y-5 md:space-y-10">
        ...
        >
          ...
          >
            Fated</a
          >🙇‍♀️<br />One-Stop Dating Website
        </h1>

        <div class="download-buttons md:flex gap-1 md:gap-10">
          <a class="download-btn text-white bg-pink-800 submit-button hidden md:block" href="https://apps.apple.com/sg/app/keynote/id6443554112" target="_blank">
